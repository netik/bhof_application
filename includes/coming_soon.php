<?php
include_once ("db_incl.php"); //change other pages to include_once too
$db=dbconnect ();
session_start(); 
?>
...
<table width="600" border="0" align="center">
  <tr>
    <td width="847"><p align="center"><strong>Thank you for stopping by! </strong>The online application system will be open in early November for the 2014 Weekend. But the <a href="../help/rules.php">rules</a>, <a href="../help/instructions.php">application instructions</a>, and <a href="../help/judging_criteria.php">evaluation criteria</a> are now available! </p>
      <p align="center"><strong>There are a few rule updates since last year. For instance, this year,</strong> <strong>we're allowing each soloist or group to submit up to two acts.</strong> (So go check out the rules!)</p>
    ...
    <p align="center"><strong>To be notified by email when the application system opens, opens, go <a href="http://eepurl.com/Hniz1" title="Notification sign-up form" target="_blank">here</a></strong><strong>.</strong> (You'll receive two notification emails: when the application opens, and two weeks before it closes. This will not add you to any other lists.) In the meantime, here's some information about  <a href="http://www.burlesquehall.com/selection/" target="_blank">how the selection process works</a>. </p></td>
  </tr>
</table>
