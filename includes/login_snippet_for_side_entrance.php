...
if ($_POST[login]){
	...
	if ($m)  //means "if it finds a record that matches email". This returns a record as an array.
		...
		if ($login_user ==1)
			...
			//Next few lines decide where to take them now that login is successful. If deadline is not passed, takes them to Welcome. If deadline has passed, takes them to results.php. 
			//NOTE: this file has a different expiration date than the main one, this one is unique to the Side Entrance to allow for late entrants.
			//  The code that checks for this is from http://www.cyberscorpion.com/2011-06/using-php-to-dynamically-hide-content-after-an-expiration-date/. 
						//SET THE TIME ZONE
			...
			$deadline_ts = mktime(0,10,0,2,01,2014);    //Format to shut it off 10 mins after midnight on date is (0,10,0,1,27,2014) or (h, m, s, month, day, year)
...
<h3 align="center"><font color="ffffff" class="highlight">Deadline:</font> applications are due 
  ...
  <script language="JavaScript"> //from http://www.hashemian.com/tools/javascript-countdown.htm
		TargetDate = "01/27/2014 11:59 PM UTC-0800";
		BackColor = "white";
		ForeColor = "red";
		CountActive = true;
		CountStepper = -1;
...
<table width="937" height="335" border="1" align="center" cellpadding="12" cellspacing="3" bordercolor="" class="boxhighlight" style="background-color:">
    <tr valign="top"> 
      ...
      <td width="517"> <label> </label> <p> 
        ...
        <ul>
          <li><strong>Fall 2013:</strong> <span class="highlight">application rules posted</span></li>
          <li><strong>Fall 2013:</strong> <span class="highlight">2014 application opens</span></li>
          ...
          <li><strong>January 15, 2013:</strong> <span class="highlight">deadline for reduced price application fee</span><span class="highlight"><img src="../assets/help_icon_2013.png" alt="Deadline on this day is 11:59pm PST. Payment before this is $29 (reduced price). Payment after this is $39 (full price)." width="18" height="18" title="Deadline on this day is 11:59pm PST. Payment before this is $29 (reduced price). Payment after this is $39 (full price)."></span></li>
          <li><strong><?php echo $deadline_without_time;?></strong><strong>:</strong> <span class="highlight">application deadline</span></li>
          <li><strong>March 2014:</strong> <span class="highlight">application notifications</span></li>
          <li><strong>March 2014:</strong> <span class="highlight">Weekend passes go on sale</span></li>
          <li><strong>April 2014:</strong> <span class="highlight">tickets go on sale</span></li>
          <li><strong>May 1, 2014:</strong> <span class="highlight"><a href="http://bhofweekend.com/attend/hotel/">hotel group rate</a> expires</span></li>
          <li><strong>June 5-8, 2014:</strong> <span class="highlight">2014 Weekender</span></li>
        </ul>
        <p> 
          <label></label>
        </p></td>
