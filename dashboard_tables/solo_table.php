...
<table width="95%" border="2" align="center" cellpadding="6" cellspacing="2" bordercolor="#999999" style="background-color:#e9f2f1">
  <tr> 
    <td colspan="2" bgcolor="#FFCCFF"><div align="center"><font color="#232929"><strong>SOLO ACT form</strong></font></div></td>
  ...
  <tr> 
    <td width="81" rowspan="2"><div align="center"><font color="232929" id="red"><strong>Do this part FIRST!</strong></font></div></td>
    ...
    Person and the act being submitted.  <span id="red">Please complete this FIRST</span> before making the payment.</font></td>
  </tr>
  <tr>
    <td width="210"><a href="forms/solo_act_info.php"><font color="#781428" size="-1"><strong>Solo</strong> act - basic info</font></a></td>
    <td align="center"><font color="#781428" size="-1">5-10 mins </font></td>
    <td align="center"><?php echo showcompleted($completed[solo_act_info]);?></td>
  </tr>
  <tr> 
    ...
    <td><p><font color="#781428" size="-1">Fee is due via credit card or PayPal account on 
        ...
        payment NEXT, then work on the rest of the application. Please allow up to 12 hours to see it updated here, although we try to process them a few times a day. As the deadline nears, we'll be doing them more frequently to make sure everyone can get their application submitted.</strong></font></font></p>
    <p><strong><font color="#781428" size="-1">Payment is $29 and partially refundable if made before December 15, 2013; then $29 and nonrefundable until January 15, 2014; then $39 and nonrefundable until the application closes. After payment, you still have until <?php echo $deadline_abbrev;?> to complete and fully submit the application.</font></strong></p></td>
  </tr>
  <tr>
    <td rowspan="2"><div align="center"><font color="232929"><strong>Part 3</strong></font></div></td> 
    <td><a href="forms/solo_act_essays.php"><font color="#781428" size="-1"><strong>Solo</strong> act - short answers</font></a></td>
    <td><div align="center"><font color="#781428" size="-1">5 mins</font></div></td>
    <td align="center"><?php echo showcompleted($completed[solo_act_essays]);?></td>
  ...
  <tr>
    <td><a href="forms/solo_act_tech.php"><font color="#781428" size="-1"><strong>Solo</strong> act - tech/staging info</font></a></td>
    <td><div align="center"><font color="#781428" size="-1">10-15 mins</font></div></td>
    <td align="center"><?php echo showcompleted($completed[solo_act_tech]);?></td>
  </tr>
  <tr>
